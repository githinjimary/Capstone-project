...
label=Label(root,text="ATTENDANCE REGISTER",font=my_font,foreground="#283142").pack()
...
photo4=PhotoImage(file='./file.png')
photo5=PhotoImage(file='./exit.png')
photo6=PhotoImage(file='./clock.png')
photo7=PhotoImage(file='./camera1.png')
photo8=PhotoImage(file='./upimg.png')
...
Bt1=Button(rightframe,text="New Entry",command=Open_new,image=photo1,activebackground="black", bd=0,width=10)
Bt1.pack(fill=X)
Bt2=Button(rightframe,text="Start",command=start,image=photo2,activebackground="black", bd=0)
Bt2.pack(fill=X,pady=10)

#Bt3=Button(rightframe,text="Stop(Press'Q')",image=photo3,activebackground="black", bd=0,command=stop)
#Bt3.pack(fill=X,pady=10)
Bt4=Button(rightframe,text="files",width=10,command=open_file,image=photo4,activebackground="black", bd=0)
Bt4.pack(fill=X,pady=10)
Bt2=Button(rightframe,text="EXIT",command=call_me,image=photo5,activebackground="black", bd=0)
Bt2.pack(fill=X,pady=10)
frame1=LabelFrame(rightframe,text="Input",padx=5,pady=5)
h=StringVar()
check_bt=Checkbutton(rightframe,text="Set Time",variable=h, offvalue="uncheck",onvalue="check",activeforeground="black",width=120,image=photo6,compound=TOP)
check_bt.pack(side=LEFT)
M=StringVar()
check_bt=Checkbutton(rightframe,text="Upload Image",variable=M, offvalue="uncheck",onvalue="check",activeforeground="black",width=120,image=photo8,compound=TOP)
check_bt.pack(side=RIGHT)
k=StringVar()
check_bt=Checkbutton(rightframe,text="Set Camera",variable=k, offvalue="cameraoff",onvalue="cameraon",activeforeground="black",width=130,image=photo7,compound=TOP)
check_bt.pack(side=RIGHT)
#check_bt=Checkbutton(rightframe,text="Set Time",variable=h, offvalue="uncheck",onvalue="check",activeforeground="black",selectcolor="red",width=50)
#check_bt.pack()
